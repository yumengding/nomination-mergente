...
#se connecter
time.sleep(3)
browser.find_element_by_xpath('//*[@id="formulaire_nomade"]/form/table/tbody/tr[1]/td[2]/input').send_keys('***')
browser.find_element_by_xpath('//*[@id="formulaire_nomade"]/form/table/tbody/tr[2]/td[2]/input').send_keys('******')
